# Operator Quickstart — Community Textile Spinning

Shortest path from clone to a verified local dry-run for **ISIC 1311** (`cloud-itonami-isic-1311`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1311.git
cd cloud-itonami-isic-1311
```
...
- Blueprint governor key: `textile-spinning-governor`
- Likely source path: `textile.governor.cljc`
